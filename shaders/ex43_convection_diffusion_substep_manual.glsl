...
// (manually copy framebuffer/program for substeps within single display frame)
//
...
void mainImage2(out vec4 frag_color, vec2 frag_coord, sampler2D buf) {
  if (iFrame <= 1) {
